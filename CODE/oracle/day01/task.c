...
static unsigned int sqlctx = 9795;
...
{12,4130,1,0,0,
5,0,0,1,0,0,27,13,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,60,0,4,15,0,0,3,0,0,1,0,2,3,0,0,2,97,0,0,2,3,0,0,
63,0,0,3,0,0,30,23,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.sqhstv[0] = (         void  *)userpasswd;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select id ,name ,region_id into :b0,:b1,:b2:b3  from s_dep\
t ";
   ...
   sqlstm.sqhstv[2] = (         void  *)rids;
   sqlstm.sqhstl[2] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[2] = (         int  )sizeof(int);
   sqlstm.sqindv[2] = (         void  *)indrids;
